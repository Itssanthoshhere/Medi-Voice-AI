...
const guaranteeCards = [
  {
    ...
    description:
      "All plans include access to 10+ AI Doctor agents with bundled voice calls and instant medical summaries.",
  },
  {
    icon: Clock,
    title: "Cancel anytime",
    description:
      "Start monthly or yearly with total freedom. Cancel anytime directly from your dashboard billing settings.",
  },
  {
    icon: Sparkles,
    title: "7-day trial window",
    description:
      "Validate MediVoice AI with full specialist consultations before any commitment on our Pro plan.",
  },
  {
    icon: Shield,
    title: "30-day money-back",
    description:
      "Risk-free 30-day evaluation period for Clinic plans. 100% full refund if you are not fully satisfied.",
  },
];
...
const highlights = [
  {
    ...
    description:
      "Consult with specialized AI medical agents trained on clinical guidelines.",
  },
  {
    icon: FileText,
    title: "Clinical Reports",
    description:
      "Auto-generated structured reports with symptoms, diagnosis, and recommendations.",
  },
  {
    icon: Shield,
    title: "HIPAA-Ready",
    description:
      "Enterprise-grade security and privacy for all your medical data.",
  },
  {
    icon: Headphones,
    title: "Voice Consultations",
    description:
      "Natural voice conversations with AI doctors — just like a real visit.",
  },
];
...
function BillingPage() {
  ...
  const handleUpgrade = async (planKey: string) => {
    ...
    try {
      ...
      setSuccessMessage(
        `Successfully upgraded to the ${targetPlan.toUpperCase()} plan!`,
      );
  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      {/* Section 1: Hero & Pricing Cards Canvas (Soft ambient shading) */}
      <section className="bg-gradient-to-b from-gray-50/90 via-white to-gray-50/40 p-6 sm:p-10 rounded-3xl border border-gray-200/60 shadow-xs space-y-8 max-w-6xl mx-auto">
            ...
            return (
              <div
                ...
                className={`relative rounded-2xl border-2 ${
                  ...
                  plan.badge === "Most Popular" && !isCurrentPlan
      ...
      {/* Section 2: Guarantee Cards (Soft slate background shading) */}
      <section className="bg-[#f8fafc] p-6 sm:p-8 rounded-3xl border border-gray-200/60 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {guaranteeCards.map((card, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-5 rounded-2xl bg-white border border-gray-200/80 shadow-2xs flex flex-col justify-between space-y-3"
              >
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="p-5 rounded-2xl bg-white border border-gray-200/70 shadow-2xs hover:border-gray-300 transition-colors"
              >
      ...
      <section className="text-center max-w-6xl mx-auto bg-gradient-to-br from-red-50/80 via-rose-50/40 to-white rounded-3xl p-10 border border-red-200/80 shadow-sm">
        ...
        <p className="text-sm text-gray-500 mb-6 max-w-md mx-auto">
          ...
          and accessible medical consultations.
        </p>
