      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        {plans.map((plan) => {
          ...
          return (
            <div
              key={plan.key}
              className={`relative rounded-2xl border-2 ${plan.borderColor} bg-white p-6 flex flex-col transition-all hover:shadow-lg ${
                plan.badge === "Most Popular" ? "shadow-md scale-[1.02]" : ""
              }`}
            >
              {/* Badge */}
              {plan.badge && (
